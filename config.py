...
API_ID = int(os.environ.get("26576868", 0))
...
PRIVATE_CHANNELS = os.environ.get("https://t.me/+D16GXeCa2fpkODQ1", "")
# Backup channel where bot may copy messages
BACKUP_CHANNEL = os.environ.get("https://t.me/+1a3O_uyhtYQ4MjM9", "")
